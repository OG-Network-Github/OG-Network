...
notify = (x) =>{
    ...
    if(x == "User"){
        document.querySelector('#winner').setAttribute('style', 'color: #38FF12;')
    }
    else if(x == "Computer"){
        document.querySelector('#winner').setAttribute('style', 'color: #FF3131;')
    }
    else{
        document.querySelector('#winner').setAttribute('style', 'color: #FFAD00;')
    } 
    document.querySelector('.exit-0').addEventListener('click',()=>{
        document.querySelector('#winner').removeAttribute('style')
...
// document.querySelector('.surrender').forEach((v) =>{
...
document.querySelectorAll('.surrender').forEach((v) => {
    v.addEventListener('click', () => {
        document.querySelector('.rounds').classList.add('hidden');
        document.querySelector('.surrender-card').classList.remove('card-hidden');
        document.querySelector('.exit-4').addEventListener('click', () => {
